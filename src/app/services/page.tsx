...
const page: React.FC = () => {
  return (
    <>
      <Head>
        <title>Our Services | MsCorpres</title>
        <meta name="google-site-verification" content="KKOvYSdxhIKXdM5mcrwSqgylO-ZYk3OsBaAKfF59F0s" />
        <meta name="description" content="Discover the range of services we offer to cater to your needs." />
        <meta name="keywords" content="MsCorpres Services, Professional Services, Solutions" />
      </Head>
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1">
            <div className="lg:px-[50px] px-[20px] space-y-2">
              ...
              <p className="text-white lg:text-[15px] text-[13px]">
                At MSCorpres, our groundbreaking services are backed by a stellar team that turns business growth aspirations into reality. Guided by innovation and a positive mindset, our team&apos;s unique viewpoints lead the way. Meet our dedicated members and witness the
